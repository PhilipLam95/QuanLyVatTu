...
namespace QLYVATTU.STACK
{
    class Vattu_Command : Command
    {
        ...
        private int CreateVatTu(ListVatTu vt)
        {
            ...
            string[] name = { "@MAVT", "@TENVT", "@MALOAI","@DONVI","@DONGIA" };
            object[] param = { vt.MAVT, vt.TENVT,vt.MALOAI,vt.DONVI,vt.DONGIA };
            return Access.ExecuteNonQuery("SP_TAO_VATTU", name, param, 5);
        }
